...
async def run_simulation(
    ...
    try:
        ...
        while True:
            ...
            guideline = (
                "\n\n【重要な対話スタイル指示】:\n"
                "1. 難しい専門用語（二元コード、作動的閉鎖、構造的結合、排中律など）や"
                "論文・目次風の堅苦しい表記は【絶対禁止】です。\n"
                "2. 専門知識のない一般人が読んでも一発で理解できる、"
                "身近で分かりやすい「普通の人間らしい話し言葉（丁寧な口語）」で"
                "発言してください。\n"
                "3. 例：「法的ルールとしてそれはダメですね」"
                "「それだと予算オーバーになっちゃいます」"
                "「ニュースで話題になって世間が注目しますね！」"
                "「データ的に根拠が薄いです」"
                "といった身近な言葉を使って相手の意見に楽しく会話・議論してください。\n"
                "4. 自分の役割（弁護士、CFO、研究者、編集長など）になりきって"
                "人間味豊かに語りかけてください。"
            )
            messages = [
